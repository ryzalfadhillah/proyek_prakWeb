...
$ambil = mysqli_query($conn, "SELECT * FROM produk WHERE produk_id='$id_menu'");
        ...
        <div class="card p-5 mb-5">
            <form method="POST" action="edit.php" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="menu1" name="nama_menu" value="<?php echo $result[0]['nama_produk'] ?>">
                </div>
                <div class="form-group">
